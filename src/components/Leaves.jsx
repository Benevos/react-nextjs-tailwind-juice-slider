...
function Leaves({ currentIndex }) 
{
    ...
    return (
        <>
            ...
            <Image width={50} height={50}  name='leaf-right' alt='leaf' src='/leaf.png' style={{rotate: (leafDegres[1]+(100*(currentIndex)))+'deg'}}
                    className='absolute w-auto blur-sm transition-all duration-1000 h-[130px] max-md:h-[100px] 
                            right-[-50px] bottom-[-30px] z-[15]'/>
                            
            <Image width={50} height={50}  name='leaf-right'  alt='leaf' src='/leaf.png' style={{rotate: (leafDegres[5]+(100*(currentIndex)))+'deg'}}
            ...
            <Image width={50} height={50}  name='leaf-left' alt='leaf' src='/leaf.png' style={{rotate: (leafDegres[3]+(100*(currentIndex)))+'deg'}}
            ...
            <Image width={50} height={50}  name='leaf-left' alt='leaf' src='/leaf.png' style={{rotate: (leafDegres[4]+(100*(currentIndex)))+'deg'}}
                    className='absolute w-auto transition-all duration-1000 h-[35px] max-sm:h-[25px]
